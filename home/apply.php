             ...
             <div class="row">
                 ...
                 <div class="col-md-4">
                                    ...
                                    <div class="form-group"><span style="color:red">&nbsp;<b>*</b></span>
                                        ...
                                        <select class="form-control" data-val="true" data-val-number="The field Marital Status must be a number." required data-val-required="Marital Status is required" id="MaritalStatusID" name="maritalstatus" required><option value="">-- Select Status --</option>
