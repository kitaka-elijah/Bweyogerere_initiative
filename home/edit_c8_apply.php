...
if (isset($_POST['parentsSearch'])) {
    $data = getPosts();
    $search_Query = "SELECT * FROM childReg8 WHERE student_id ='$data[0]'"; 
...
<div class="list-group">
     ...
     <a href="edit_c8_apply.php" class="list-group-item active">
...
<div class="container">
        ...
        <form action="edit_c8_apply.php" method="post"><input name="__RequestVerificationToken" type="hidden" value="4qcTXQjUp670Plq5n1m2yfWgCBZ_oBLJTdBRRDNSAFcAeg4jflnvkQILRJDGMFLajdGHrEDNJlk88NFyy-Z40eJ54n16L4ZsFp7OX3wOssfEpouABpdFEa2gCCbtfdg1pl-viISopFbYyqkS72dvZw2" />
...
-->
                 ...
                 <div class="col-sm-4">
                      ...
                      <form action="c8_pic_edit.php" method="post" enctype="multipart/form-data" class="md-form" class="work-request" enctype="multipart/form-data" id="docUpload" >
