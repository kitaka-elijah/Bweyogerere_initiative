...
WHERE preg.parents_id = '$parent_id' AND crg.parents_id = '$parent_id' AND crg.student_ID = '$student_ID' AND crg2.student_ID = '$student_ID2' AND crg3.student_ID = '$student_ID3' 
");
