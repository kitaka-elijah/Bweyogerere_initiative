...
<div class="list-group">
            <a href="apply6.php" class="list-group-item active">
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-box single-line" required name="student2_ID" placeholder="Child ID" type="text" value="<?php  echo $_SESSION["parents_id"]."-002"; ?>" readonly style ="color:red;";/>
...
<option value="1899">1899</option>
  ...
  <!--  <div class="col-md-4 col-sm-6 col-xs-6">
        <a href ="apply5.php"  class="btn btn-warning btn-block btn-default">
    ...
    <div class="col-md-4  col-sm-6 col-xs-6">
        <button name="saveandAddSecondChild" value="saveContinue" type="submit" class="btn btn-primary btn-block btn-label-next" style="border-radius: 0px;">
