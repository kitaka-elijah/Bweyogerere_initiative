...
echo "<h1>".$insert."</h1>" ;
            ...
            <html>
            <head>
            <meta http-equiv="refresh" content="0;url=edit_c2_apply.php">
            <title>Parents PP</title>
            <script language="javascript">
            window.location.href = "edit_c2_apply.php"
            </script>
            </head>
            </html>
            ';
            ...
            <html>
            <head>
            <meta http-equiv="refresh" content="0;url=errors/c2_invalid.html">
            <title>Error 204</title>
            <script language="javascript">
            window.location.href = "errors/c2_invalid.html"
            </script>
            </head>
            </html>
            ';
