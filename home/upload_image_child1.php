    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
            ...
            // Insert image file name into database
                $insert = $db->query( "UPDATE childReg 
                SET 
            ...
            window.location.href = "apply5.php"
            </script>
            </head>
            </html>
            ';
            ...
            <html>
            <head>
            <meta http-equiv="refresh" content="0;url=errors/error204_No_Content2.html">
            <title>Error 204</title>
            <script language="javascript">
            window.location.href = "errors/error204_No_Content2.html"
            </script>
            </head>
            </html>
            ';
            ...
            <html>
            <head>
            <meta http-equiv="refresh" content="0;url=errors/400_bad_request2">
            <title>Error 204</title>
            <script language="javascript">
            window.location.href = "errors/400_bad_request2.html"
            </script>
            </head>
            </html>
            ';
        ...
        $statusMsg = 'Sorry, only JPG, JPEG, PNG, GIF, & PDF files are allowed to upload.';
          echo'
            ...
            <title>Error 204</title>
            <script language="javascript">
            window.location.href = "errors/400_bad_request_fileextastionerror2.html"
            </script>
            </head>
            </html>
            ';
