...
<div class="list-group">
            <a href="apply3.php" class="list-group-item active">
                <text class=""><i class="fa fa-spinner"></i>Add First Child-1 </text>
            </a>



            <a href="apply4.php" class="list-group-item ">
                <text><i class=""></i>Add First Child Passport Photo-1</text>
            </a>
    <!--
    <a href="apply5.php" class="list-group-item ">
            ...
            <a href="apply6.php" class="list-group-item ">
                <text><i class=""></i>Add Second Child Passport Photo-2</text>
            </a>
    
    
     <a href="apply7.php" class="list-group-item  ">
                <text class=""><i class="fa fa-spinner"></i>Add Third Child-3 </text>
            </a>



            <a href="apply8.php" class="list-group-item ">
                <text><i class=""></i>Add Third Child Passport Photo-3</text>
            </a>
    
       <a href="apply9.php" class="list-group-item  ">
                <text class=""><i class="fa fa-spinner"></i>Add Fourth Child-4 </text>
            </a>



            <a href="apply10.php" class="list-group-item  ">
                <text><i class=""></i>Add Fourth Child Passport Photo-4</text>
            </a>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-box single-line" required name="student1_ID" value="<?php  echo $_SESSION["parents_id"]."-001"; ?>" type="text"  readonly style ="color:red;";/>
...
<option value="1899">1899</option>
  ...
  <!--  <div class="col-md-4 col-sm-6 col-xs-6">
        <a href ="apply2.php"  class="btn btn-warning btn-block btn-default">
