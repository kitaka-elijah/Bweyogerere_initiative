...
<div class="list-group">
            <a href="apply21.php" class="list-group-item active">
                <text class=""><i class="fa fa-spinner"></i>Add Seventh Child-7 </text>
            </a>



            <a href="apply22.php" class="list-group-item ">
                <text><i class=""></i>Add Seventh Child's Passport Photo-7</text>
            </a>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control text-box single-line" required name="student7_ID" placeholder="Child ID" type="text" value="<?php  echo $_SESSION["parents_id"]."-007"; ?>" readonly style="color:red";/>
...
<option value="1899">1899</option>
   ...
   <!-- <div class="col-md-4 col-sm-6 col-xs-6">
        <a href ="apply20.php"  class="btn btn-warning btn-block btn-default">
    ...
    <div class="col-md-4  col-sm-6 col-xs-6">
        <button name="saveandAddseventhChild" value="saveContinue" type="submit" class="btn btn-primary btn-block btn-label-next" style="border-radius: 0px;">
